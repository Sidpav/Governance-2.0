...
ROLES = {
    ...
    "business_leader": {
        ...
        # May sponsor and deliver use cases, but cannot approve or override
        # their own portfolio submission.
        "pages": set(ALL_PROTECTED_PAGES) - {PAGE_GOVERNANCE_REVIEW},
    },
    "program_leader": {
...
USERS = {
    ...
    "programleader@cortexa.com":      {"name": "Program Leader", "role": "program_leader"},
